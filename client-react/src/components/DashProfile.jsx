    ...
    return (
        <div className={"max-w-lg mx-auto p-3 w-full"}>
            ...
            <form onSubmit={handelSubmit} className={"flex flex-col gap-4"}>
                ...
                <TextInput type={"text"} id={"username"} onChange={handelChange} placeholder={"username"}
                           defaultValue={currentUser.username}/>
                <TextInput type={"email"} id={"email"} onChange={handelChange} placeholder={"email"}
                ...
                <Modal.Body>
                    <div className={"text-center"}>
                        ...
                        <h3 className={"mb-5 text-lg text-gray-700 dark:text-gray-400 font-semibold"}>Are you sure you
                            want to delete your account ?</h3>
